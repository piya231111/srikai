...
public class getFoodDataService extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String name = requestUrl.substring("/srikai/getFoodDataService/".length());
        ...
        if (food != null) {
            ...
            json += "\"type\": " + JSONObject.quote(food.getFoodType()) + ",\n";
            json += "\"Topping\": " + JSONObject.quote(food.getTopping()) + ",\n";
            json += "\"SweetLevel\": " + JSONObject.quote(food.getSweetLevel()) + ",\n";
